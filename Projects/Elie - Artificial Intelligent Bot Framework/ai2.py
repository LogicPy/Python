...
def main():
	...
	tts.save("w.mp3")
	tts = gTTS(text=speechArray[23], lang='en')
	tts.save("x.mp3")
	...
	tts.save("a1.mp3")
	tts = gTTS(text=speechArray[27], lang='en')
	tts.save("a2.mp3")
	tts = gTTS(text=speechArray[28], lang='en')
	tts.save("a3.mp3")
	tts = gTTS(text=speechArray[29], lang='en')
	tts.save("a4.mp3")
		...
		if r == 0:
			if x=="hello":
				...
				if q != z:
					...
					pygame.mixer.music.play()
				z = "you know"
			elif "no problem" in x:
				if q!=z:
					print speechArray[27]
					pygame.mixer.init()
				...
				if q!=z:
					print speechArray[28]
					pygame.mixer.init()
					pygame.mixer.music.load('a3.mp3')
					pygame.mixer.music.play()
					z = "chili"
				else:
					print speechArray[29]
					pygame.mixer.init()
