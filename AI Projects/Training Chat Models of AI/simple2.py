...
model_name = "gpt2-large"  # Replace this with the desired model, e.g. "gpt2-medium", "gpt2-large", or "gpt2-xl"
...
# Load dataset
train_file = "./story_dataset.json"  # Replace with the path to your training data
