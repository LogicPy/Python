...
def detect_phishing():
    ...
    result, explanation = detect_phishing_route_logic(email_content)

    confidence = 'High' if result in ['This email appears to be a phishing attempt.', 'This email seems safe.'] else 'Low'
